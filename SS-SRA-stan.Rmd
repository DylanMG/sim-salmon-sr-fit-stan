...
Next we need to generate data frames of spawner and harvest observations, in this case by assuming a SD of 20% for spawners and 5% for harvest; this extra noise is the observaiton error:
...
nRyrs <- nyrs + a_max + 1 # number of recruitment years ## should be nyrs + A_max + 1 to get all unobserved states?
